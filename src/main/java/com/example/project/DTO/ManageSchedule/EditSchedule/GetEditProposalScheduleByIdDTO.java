...
public class GetEditProposalScheduleByIdDTO {
    ...
    public GetEditProposalScheduleByIdDTO(String projectId, String projectTitle, String program, String semester, Map<String, List<String>> instructorNames, String date, LocalDateTime startTime, LocalDateTime endTime, String room, String status, String editedByUser) {
