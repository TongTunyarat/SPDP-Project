...
public interface ProjectRepository extends JpaRepository<Project, String> {
    // List<Project> findByProjectTitleOrProjectDescription(String projectTitle, String projectDescription);

    // List<Project> findByProjectTitleContainingIgnoreCaseOrProjectDescriptionContainingIgnoreCase(String title, String description);
