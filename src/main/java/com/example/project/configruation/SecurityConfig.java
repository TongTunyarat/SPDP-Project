...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                .csrf(csrf -> csrf
                        .ignoringRequestMatchers("/user/details", "/testsave", "/saveEvaluation", "/getEvaluation", "/saveDefenseEvaluation", "/getDefenseEvaluation", "/savePosterEvaluation", "/getPosterEvaluation", "/scoreTotal", "/scoreTotalPoster", "/saveProposalGrade","/getGradeProposal", "/saveDefenseGrade", "/getGradeDefense", "/instructor/showGradeScoreDefense", "/admin/projectOverview", "/admin/uploadProjectFiles", "/admin/editDetails", "/admin/updateProjectDetails", "/admin/deleteProject/**","/admin/deleteAllProjects", "/admin/deleteStudentFromProject/**", "/admin/deleteInstructorFromProject/**", "/admin/addProject", "/admin/editDetails", "/get-instructorId", "/api/proposal-evaluation", "/api/defense-evaluation", "/scoring-periods", "/admin/previewFiles", "/admin/uploadCommitteeFiles", "/admin/uploadPosterCommitteeFiles","/admin/validateProjectFiles", "/admin/uploadProjectDBFiles")
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/login", "/css/**", "/js/**", "/publicProjectDetail","/student", "/instructor/criteriaDefenseGrade", "/testsave", "/saveEvaluation", "/getEvaluation", "/saveDefenseEvaluation", "/getDefenseEvaluation", "/savePosterEvaluation", "/getPosterEvaluation", "/scoreTotal", "/scoreTotalPoster", "/saveProposalGrade", "/getGradeProposal", "/saveDefenseGrade", "/getGradeDefense", "/instructor/showGradeScoreDefense", "/get-instructorId", "/api/proposal-evaluation", "/api/defense-evaluation",  "/scoring-periods", "/admin/projectOverview", "/admin/uploadProjectFiles", "/admin/editDetails", "/admin/updateProjectDetails", "/admin/deleteProject/**","/admin/deleteAllProjects", "/admin/deleteStudentFromProject/**" , "/admin/deleteInstructorFromProject/**","/admin/addProject", "/admin/editDetails", "/admin/previewFiles", "/admin/uploadCommitteeFiles", "/admin/uploadPosterCommitteeFiles", "/admin/validateProjectFiles", "/admin/uploadProjectDBFiles").permitAll() // อนุญาตให้ทุกคนเข้าถึง
